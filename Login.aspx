   ...
   <form id="form1" runat="server">
    <header class="header1">
        ...
        <div class="contain1" style="margin-left: 15%; padding-top: 20px; padding-right: 10%; max-width: 100%">
            <h1 style="text-align: center; padding-bottom: 30px; padding-top: 30px;">Login to your account now</h1>
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Login as Tailor" BackColor="#000099" ForeColor="White" OnClick="Button1_Click" Width="225px" CssClass="auto-style4" Height="42px" style="padding-right: 5px;"/>
            <asp:Button ID="Button3" runat="server" BackColor="#000099" ForeColor="White" Height="42px" OnClick="Button3_Click" Text="Login as customer" Width="225px" />
        </p>
            <p>
                &nbsp;</p>
             </div>
            <div class="contain2">
                ...
                <h1 style="color: white; font-size: 40px">Dont Have any account</h1><br />
                <p style="color: white;">Register now to see the best option available and affodable for you</p><br />
                
                <button class="auto-style5" style="background-color: deepskyblue"><a href="/WebForm1.aspx" style="color: white;">Register now</a>
                    </button>
                    </div>
            </div>
            </div>
