...
<body>
    ...
    <header class="header1">
        ...
        <br />
        <a style="padding-right: 0%" href="/users/apply">
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="#000099" ForeColor="White" OnClick="Button1_Click" Width="455px" CssClass="auto-style4" Height="42px" />
        </p>
             </div>
            <div class="contain2">
